[![Build Status](https://travis-ci.org/arnesson/cordova-plugin-firebases.svg?branch=master)](https://travis-ci.org/arnesson/cordova-plugin-firebases)

# cordova-plugin-firebases
